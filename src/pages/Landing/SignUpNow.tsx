import { Heading, Flex, Stack, Image, StackProps, HeadingProps, useToken, Button } from "@chakra-ui/react";
...
const SignUpNow: React.FC<StackProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Flex justify="space-around" width={{ base: "100%", md: "50%" }} height="100%" mt={{ base: 6, md: 0 }} display={{ base: "none", md: "flex" }}>
